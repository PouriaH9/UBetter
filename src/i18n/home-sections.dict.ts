...
export const homeSectionsCopy: Record<Locale, HomeSectionsDict> = {
  fa: {
    ...
    certificates: {
      ...
      subtitle: "محصولات یوبتر با بالاترین استانداردهای بین‌المللی تست و تأیید شده‌اند.",
      cards: [
    ...
    projects: {
      ...
      subtitle: "راهکارهای ذخیره‌سازی انرژی در صنعت، تجاری، مسکونی و برق اضطراری.",
      cards: [
        { title: "ESS صنعتی ۵۰۰kWh", desc: "کاهش ۳۸٪ هزینه برق اوج در کارخانه تولیدی.", tag: "صنعتی" },
        { title: "سیستم تجاری چندملکی", desc: "سه ملک تجاری — بازگشت سرمایه در ۱۸ ماه.", tag: "تجاری" },
        { title: "UPS و برق اضطراری", desc: "پشتیبان‌گیری برای دیتاسنتر و تجهیزات حساس.", tag: "اضطراری" },
      ],
      cta: "مشاهده پروژه‌ها",
    },
    articles: {
      ...
      cards: [
        { title: "انتخاب ظرفیت UPS", desc: "چگونه بار مصرفی را محاسبه و UPS مناسب انتخاب کنیم.", tag: "راهنما" },
    ...
    catalog: {
      ...
      subtitle: "کاتالوگ کامل محصولات یوبتر — معرفی ۲۳ محصول در ۶ دسته‌بندی.",
      cards: [],
      cta: "دانلود کاتالوگ",
    },
    contact: {
  ...
  en: {
    ...
    projects: {
      ...
      subtitle: "Energy storage solutions for industrial, commercial, residential, and backup power.",
      cards: [
        { title: "500 kWh Industrial ESS", desc: "38% peak electricity cost reduction at a manufacturing plant.", tag: "Industrial" },
        { title: "Multi-property Commercial", desc: "Three commercial sites — ROI within 18 months.", tag: "Commercial" },
        { title: "UPS & Emergency Power", desc: "Backup for data centers and critical equipment.", tag: "Emergency" },
      ],
      cta: "View Projects",
    },
    articles: {
      ...
      cards: [
        { title: "Choosing UPS Capacity", desc: "How to calculate load and select the right UPS.", tag: "Guide" },
    ...
    catalog: {
      ...
      subtitle: "Full UBETTER product catalog — 23 products across 6 categories.",
      cards: [],
  ...
  zh: {
    ...
    projects: {
      badge: "案例",
      title: "项目与应用场景",
      subtitle: "面向工业、商业、住宅及应急备电的储能解决方案。",
      cards: [
        { title: "500 kWh 工商业 ESS", desc: "制造企业峰值电费降低约 38%。", tag: "工业" },
        { title: "多物业商业项目", desc: "三处商业物业 — 约 18 个月回本。", tag: "商业" },
        { title: "UPS 与应急电源", desc: "数据中心及关键设备备电。", tag: "应急" },
      ],
      cta: "查看项目",
    },
    articles: {
      ...
      cards: [
        { title: "UPS 容量选型", desc: "如何计算负载并选择合适的 UPS。", tag: "指南" },
    ...
    catalog: {
      badge: "产品资料",
      title: "下载产品目录",
      subtitle: "UBETTER 完整产品目录 — 6 大类共 23 款产品。",
      cards: [],
      cta: "下载产品目录",
    },
    contact: {
