import type { T } from '@/data/product-categories';
...
export const PRODUCT_TRANSLATIONS: ProductTranslation[] = [
  {
    "productNum": 1,
    "name": {
      "fa": "باتری ذخیره انرژی مدل ایستاده و دیواری",
      "en": "Wall-Mounted & Floor-Standing ESS Battery"
    },
    "category": {
      "fa": "باتری ذخیره انرژی خانگی و دفتری",
      "en": "Residential ESS Battery"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "وزن سبک و ابعاد جمع‌وجور",
        "en": "Lightweight and compact dimensions"
      },
      {
        "fa": "طول عمر بسیار بالا",
        "en": "Very long lifespan"
      },
      {
        "fa": "مجهز به سیستم هوشمند مدیریت باتری (BMS)",
        "en": "Smart BMS battery management system"
      },
      {
        "fa": "ایمنی فوق‌العاده بالا؛ مقاوم در برابر آتش‌سوزی، انفجار و نشتی",
        "en": "Extremely high safety — resistant to fire, explosion, and leakage"
      },
      {
        "fa": "سازگار با انواع اینورترها",
        "en": "Compatible with multiple inverter brands"
      },
      {
        "fa": "پشتیبانی از RS485، RS232 و CAN",
        "en": "RS232 / RS485 / CAN communication"
      }
    ],
    "applications": [
      {
        "fa": "برق پشتیبان منازل و آپارتمان‌ها",
        "en": "Home & apartment backup power"
      },
      {
        "fa": "سیستم‌های خورشیدی",
        "en": "Solar energy systems"
      },
      {
        "fa": "برق پشتیبان دفاتر",
        "en": "Office backup systems"
      },
      {
        "fa": "ویلاها و مزارع",
        "en": "Villas and farms"
  ...
  },
  {
    "productNum": 2,
    "name": {
      "fa": "باتری ذخیره انرژی مدل چرخدار",
      "en": "Wheeled Energy Storage Battery"
    },
    "category": {
      "fa": "باتری ذخیره انرژی خانگی و دفتری",
      "en": "Portable Residential ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "ساختار چرخدار قابل حمل",
        "en": "Portable wheeled structure"
      },
      {
        "fa": "سیستم هوشمند مدیریت باتری (BMS)",
        "en": "Smart BMS system"
      },
      {
        "fa": "استانداردهای ایمنی بالا",
        "en": "High safety standards"
      },
      {
        "fa": "جمع‌وجور و سبک",
        "en": "Compact and lightweight"
      },
      {
        "fa": "طول عمر عملیاتی بالا",
        "en": "Long operational life"
      },
      {
        "fa": "سازگاری با انواع اینورترها",
        "en": "Multi-inverter compatibility"
      },
      {
        "fa": "پشتیبانی از RS485، RS232 و CAN",
        "en": "RS232 / RS485 / CAN communication"
    ...
    "applications": [
      {
        "fa": "برق پشتیبان سیار",
        "en": "Mobile backup power"
      },
      {
        "fa": "ذخیره انرژی مسکونی",
        "en": "Residential backup"
      },
      {
        "fa": "تأمین برق موقت",
        "en": "Temporary energy supply"
      },
      {
        "fa": "سیستم‌های انرژی دفاتر",
        "en": "Office energy systems"
      }
    ]
  },
  {
    "productNum": 3,
    "name": {
      "fa": "باتری ذخیره انرژی با نمایشگر لمسی عمودی",
      "en": "Vertical ESS Battery with Touchscreen"
    },
    "category": {
      "fa": "باتری ذخیره انرژی خانگی و دفتری",
      "en": "Smart Residential Energy Storage"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "نمایشگر لمسی تعاملی",
        "en": "Interactive touchscreen display"
      },
      {
        "fa": "سیستم هوشمند مدیریت BMS",
        "en": "Smart BMS management"
      },
      {
        "fa": "طراحی عمودی مدرن",
        "en": "Modern vertical design"
      },
      {
        "fa": "طول عمر بالا",
        "en": "Long lifecycle"
    ...
    "applications": [
      ...
      {
        "fa": "سیستم‌های خورشیدی مسکونی",
        "en": "Residential solar systems"
      },
      {
        "fa": "سیستم‌های پایش انرژی",
        "en": "Energy monitoring systems"
      },
      {
        "fa": "سیستم‌های برق پشتیبان",
        "en": "Backup electricity systems"
      }
    ]
  },
  {
    "productNum": 4,
    "name": {
      "fa": "سیستم یکپارچه ذخیره انرژی ایستاده (All-in-One)",
      "en": "All-in-One Integrated ESS Cabinet"
    },
    "category": {
      "fa": "باتری ذخیره انرژی خانگی و دفتری",
      "en": "Integrated Residential ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "سیستم هوشمند مدیریت باتری (BMS)",
        "en": "Intelligent BMS system"
      },
      {
        "fa": "سیستم هشداردهی کاربرپسند",
        "en": "User-friendly warning system"
      },
      {
        "fa": "مکانیزم‌های کامل حفاظت آنلاین",
        "en": "Complete online protection mechanisms"
      },
      {
        "fa": "طراحی یکپارچه با نصب سریع و آسان",
        "en": "Integrated design with fast installation"
      },
      {
        "fa": "نمایشگر تعاملی راجب انسان و ماشین کاربرپسند",
        "en": "User-friendly interactive HMI display"
      },
      {
        "fa": "ایمنی فوق‌العاده بالا",
        "en": "Extremely high safety"
      }
    ],
    "applications": [
      {
        "fa": "سیستم‌های مسکونی هوشمند",
        "en": "Smart residential systems"
      },
      {
        "fa": "ادغام خورشیدی خانگی",
        "en": "Home solar integration"
      },
      {
        "fa": "سیستم‌های برق پشتیبان",
        "en": "Backup power systems"
      },
      {
        "fa": "بهینه‌سازی انرژی",
  ...
  },
  {
    "productNum": 5,
    "name": {
      "fa": "سیستم یکپارچه ذخیره انرژی ماژولار (Stacked)",
      "en": "Stacked Modular All-in-One ESS"
    },
    "category": {
      "fa": "ذخیره انرژی ماژولار مسکونی",
      "en": "Modular Residential ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "طراحی ماژولار با تعداد دلخواه و کاربری آسان",
        "en": "Modular expandable design with easy scalability"
      },
      {
        "fa": "نمایشگر LED برای نمایش لحظه‌ای پارامترها و وضعیت عملکرد",
        "en": "LED monitoring display"
      },
      {
        "fa": "ایمنی فوق‌العاده بالا",
        "en": "Extremely high safety"
      ...
      {
        "fa": "ساختار ماژولار با نصب آسان و سریع",
        "en": "Modular structure with fast installation"
      },
      {
        "fa": "طول عمر بسیار بالا",
        "en": "Very long lifecycle"
      },
      {
        "fa": "مجهز به سیستم هوشمند مدیریت باتری (BMS)",
        "en": "Smart BMS system"
    ...
    "applications": [
      {
        "fa": "سیستم‌های انرژی مسکونی",
        "en": "Residential energy systems"
      },
      {
        "fa": "برق پشتیبان تجاری",
        "en": "Commercial backup power"
      },
      {
        "fa": "ادغام با انرژی خورشیدی",
        "en": "Solar integration"
      },
      {
        "fa": "مدیریت هوشمند انرژی",
  ...
  },
  {
    "productNum": 6,
    "name": {
      "fa": "سیستم ذخیره انرژی ولتاژ بالا ماژولار (Stacked)",
      "en": "High-Voltage Modular All-in-One ESS"
    },
    "category": {
      "fa": "ذخیره انرژی ولتاژ بالا",
      "en": "High-Voltage Energy Storage"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "معماری ولتاژ بالا",
        "en": "High-voltage architecture"
      },
      {
        "fa": "سیستم ماژولار قابل توسعه",
        "en": "Expandable modular system"
      },
      {
        "fa": "مدیریت هوشمند انرژی",
        "en": "Smart energy management"
      ...
      {
        "fa": "نمایشگر LED",
        "en": "LED monitoring system"
      },
      {
        "fa": "طول عمر عملیاتی بالا",
        "en": "Long operational lifespan"
      },
      {
        "fa": "مجهز به سیستم هوشمند BMS",
        "en": "Smart BMS system"
      }
    ],
    "applications": [
      ...
      {
        "fa": "برق پشتیبان صنعتی",
        "en": "Industrial backup power"
      },
      {
        "fa": "ادغام با انرژی تجدیدپذیر",
  ...
  },
  {
    "productNum": 7,
    "name": {
      "fa": "باتری ذخیره انرژی قفسه‌ای (Rack-mounted)",
      "en": "Rack-Mounted ESS Battery"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی قفسه‌ای",
      "en": "Rack Energy Storage System"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "طراحی ماژولار با تعداد دلخواه و کاربری آسان",
        "en": "Modular rack-mounted architecture"
      },
      {
        "fa": "وزن سبک و ابعاد جمع‌وجور",
        "en": "Lightweight and compact"
      },
      {
        "fa": "ایمنی فوق‌العاده بالا",
        "en": "Extremely high safety"
    ...
    "applications": [
      {
        "fa": "ایستگاه‌های مخابراتی",
        "en": "Telecom stations"
      },
      {
        "fa": "ذخیره‌سازهای انرژی هوشمند",
        "en": "Smart energy storage systems"
      },
      {
        "fa": "ذخیره‌سازی خورشیدی",
        "en": "Solar storage"
      },
      {
        "fa": "سیستم‌های پشتیبان تجاری",
        "en": "Commercial backup systems"
      }
    ]
  },
  {
    "productNum": 8,
    "name": {
      "fa": "سیستم ذخیره انرژی ولتاژ بالا ماژولار 1C (از ۲۰ تا ۸۷ کیلووات ساعت)",
      "en": "C1 High-Voltage Modular ESS (20–87 kWh)"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی ولتاژ بالا تجاری",
      "en": "Commercial High-Voltage ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "ماژول‌های باتری ولتاژ بالا",
        "en": "High-voltage battery modules"
      },
      {
        "fa": "معماری قابل توسعه",
        "en": "Expandable architecture"
      },
      {
        "fa": "سیستم هوشمند مدیریت باتری (BMS)",
        "en": "Smart BMS system"
      ...
      {
        "fa": "مهندسی ایمنی پیشرفته",
        "en": "Advanced safety engineering"
      },
      {
        "fa": "سازگار با انواع اینورترها",
        "en": "Multi-inverter compatibility"
      ...
      {
        "fa": "مقیاس‌پذیری ماژولار",
        "en": "Modular scalability"
      }
    ],
    "applications": [
      {
        "fa": "پروژه‌های انرژی تجاری",
        "en": "Commercial energy projects"
      },
      {
        "fa": "تأسیسات صنعتی",
      ...
      {
        "fa": "ذخیره‌سازی انرژی خورشیدی",
        "en": "Solar energy storage"
      },
      {
        "fa": "سیستم‌های شبکه هوشمند",
        "en": "Smart grid systems"
      }
    ]
  },
  {
    "productNum": 9,
    "name": {
      "fa": "سیستم ذخیره انرژی ولتاژ بالا ماژولار 0.5C (از ۶۴ تا ۲۷۲ کیلووات ساعت)",
      "en": "C0.5 High-Voltage Modular ESS (64–272 kWh)"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی با ظرفیت بالا صنعتی",
      "en": "Industrial High-Capacity ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "سیستم ماژولار با ظرفیت بالا",
        "en": "High-capacity modular system"
      },
      {
        "fa": "طراحی ایمنی صنعتی",
        "en": "Industrial safety design"
      },
      {
        "fa": "طول عمر عملیاتی بالا",
        "en": "Long operational lifespan"
    ...
    "applications": [
      ...
      {
        "fa": "نیروگاه‌های انرژی تجدیدپذیر",
        "en": "Renewable energy plants"
      },
      {
        "fa": "سیستم‌های پشتیبان در مقیاس بزرگ",
        "en": "Large-scale backup systems"
      },
      {
        "fa": "زیرساخت‌های تجاری",
        "en": "Commercial infrastructure"
      }
    ]
  },
  {
    "productNum": 10,
    "name": {
      "fa": "سیستم ذخیره انرژی ولتاژ بالا، مدل قفسه‌ای",
      "en": "High-Voltage Rack ESS"
    },
    "category": {
      "fa": "ذخیره انرژی صنعتی قفسه‌ای",
      "en": "Industrial Rack Energy Storage"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "سیستم قفسه‌ای ولتاژ بالا",
        "en": "High-voltage rack system"
      },
      {
        "fa": "ساختار ماژولار پیشرفته",
        "en": "Advanced modular structure"
      },
      {
        "fa": "بهره‌وری بالا",
        "en": "High efficiency"
      ...
      {
        "fa": "ایمنی در سطح صنعتی",
        "en": "Industrial-grade safety"
      },
      {
        "fa": "استقرار قابل توسعه",
        "en": "Expandable deployment"
      }
    ],
    "applications": [
      {
      ...
      {
        "fa": "زیرساخت مخابراتی",
        "en": "Telecom infrastructure"
      },
      {
        "fa": "سیستم‌های برق صنعتی",
  ...
  },
  {
    "productNum": 11,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 60kWh",
      "en": "ESS 60 kWh"
    },
    "category": {
      "fa": "کابینت ذخیره انرژی تجاری",
      "en": "Commercial ESS Cabinet"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "پشتیبانی از On-Grid و Off-Grid",
        "en": "Grid-On and Grid-Off support"
      },
      {
        "fa": "مجهز به سیستم حفاظت در برابر آتش",
        "en": "Fire protection system"
      },
      {
        "fa": "سیستم تهویه مطبوع داخلی برای حفظ تعادل دما",
        "en": "Internal climate control"
      },
      {
        "fa": "طراحی الکترودها با شیارهای عایق پلاستیکی جهت جلوگیری از نشتی",
        "en": "Plastic-insulated electrode design to prevent leakage"
      },
      {
        "fa": "حفاظت‌های چندلایه ایمنی",
        "en": "Multi-layer safety protection"
      }
    ],
    "applications": [
      {
        "fa": "ساختمان‌های تجاری",
  ...
  },
  {
    "productNum": 12,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 100kWh",
      "en": "ESS 100 kWh"
    },
    "category": {
      "fa": "کابینت ذخیره انرژی تجاری",
    ...
    "features": [
      {
        "fa": "پشتیبانی از On-Grid و Off-Grid",
        "en": "Grid-connected and off-grid operation"
      },
      {
        "fa": "سیستم حفاظت پیشرفته در برابر آتش",
        "en": "Advanced fire protection"
      },
      {
        "fa": "مدیریت حرارتی هوشمند داخلی",
        "en": "Intelligent internal thermal management"
      },
      {
        "fa": "استانداردهای ایمنی بالا",
        "en": "High safety standards"
    ...
    "applications": [
      ...
      {
        "fa": "ذخیره‌سازی انرژی تجدیدپذیر",
        "en": "Renewable energy storage"
      },
      {
        "fa": "ساختمان‌های هوشمند",
        "en": "Smart buildings"
      }
    ]
  },
  {
    "productNum": 13,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 140kWh",
      "en": "ESS 140 kWh"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی صنعتی",
      "en": "Industrial Energy Storage System"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "طراحی یکپارچه و ماژولار با سطح بالای یکپارچگی",
        "en": "Integrated and modular design with high integration"
      },
      {
        "fa": "مجهز به سیستم مدیریت دیجیتال بهره‌برداری و نگهداری",
        "en": "Digital operation and maintenance management system"
      },
      {
        "fa": "ایمن و قابل اعتماد، مقاوم در برابر شرایط محیطی سخت",
        "en": "Safe, reliable, and harsh-environment resistant"
      },
      {
        "fa": "قابل استفاده در سناریوهای متنوع کاربردی",
        "en": "Multiple application scenarios"
      },
      {
        "fa": "پشتیبانی از On-Grid و Off-Grid",
        "en": "Grid-On / Grid-Off support"
      }
    ],
    "applications": [
      {
      ...
      {
        "fa": "سیستم‌های انرژی هوشمند",
        "en": "Smart energy systems"
      },
      {
        "fa": "پروژه‌های انرژی تجدیدپذیر",
  ...
  },
  {
    "productNum": 14,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 160kWh",
      "en": "ESS 160 kWh"
    },
    "category": {
      "fa": "کابینت ذخیره انرژی صنعتی",
      "en": "Industrial ESS Cabinet"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "سیستم حفاظت در برابر آتش",
        "en": "Fire protection system"
      },
      {
        "fa": "تعادل حرارتی داخلی",
        "en": "Internal thermal balancing"
      },
      {
        "fa": "ایمنی عملیاتی بالا",
        "en": "High operational safety"
      },
      {
        "fa": "بهینه‌سازی خودکار انرژی",
        "en": "Automated energy optimization"
      },
      {
        "fa": "پایایی در سطح صنعتی",
        "en": "Industrial-grade reliability"
      },
      {
        "fa": "حفاظت‌های چندلایه",
        "en": "Multi-layer protection"
      }
    ],
    "applications": [
      {
        "fa": "سیستم‌های پشتیبان صنعتی",
        "en": "Industrial backup systems"
      },
      {
        "fa": "تأسیسات تجاری",
        "en": "Commercial facilities"
  ...
  },
  {
    "productNum": 15,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 215/241kWh",
      "en": "ESS 215/241 kWh"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی تجاری بزرگ",
      "en": "Large Commercial ESS"
    },
    "description": {
    ...
    "features": [
      ...
      {
        "fa": "بهینه‌سازی نرم‌افزاری هوشمند",
        "en": "Smart software optimization"
      },
      {
        "fa": "ایمنی چندلایه",
        "en": "Multi-layer safety"
      },
      {
        "fa": "معماری با ظرفیت بالا",
        "en": "High-capacity architecture"
      }
    ],
    "applications": [
      {
      ...
      {
        "fa": "پروژه‌های بهینه‌سازی انرژی",
        "en": "Energy optimization projects"
      },
      {
        "fa": "سیستم‌های پشتیبان صنعتی",
        "en": "Industrial backup systems"
  ...
  },
  {
    "productNum": 16,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 261kWh",
      "en": "ESS 261 kWh"
    },
    "category": {
      "fa": "پلتفرم ذخیره انرژی صنعتی",
      "en": "Industrial ESS Platform"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "امکان طراحی مستقل بخش‌های AC و DC",
        "en": "Independent AC/DC design"
      },
      {
        "fa": "بهره‌گیری از استراتژی‌های سوئیچینگ هوشمند",
        "en": "Intelligent switching strategies"
      },
      {
        "fa": "کاهش پیک مصرف (Peak Shaving) و پر کردن دره مصرف (Valley Filling)",
        "en": "Peak Shaving and Valley Filling"
      },
      {
        "fa": "سیستم حفاظت در برابر آتش در سه سطح",
        "en": "Three-level fire protection"
      },
      {
        "fa": "استقرار انعطاف‌پذیر",
        "en": "Flexible deployment"
      },
      {
        "fa": "سیستم ایمن و پایدار",
        "en": "Safe and stable system"
      }
    ],
    "applications": [
      {
        "fa": "زیرساخت انرژی صنعتی",
        "en": "Industrial energy infrastructure"
      },
      {
        "fa": "تعادل‌سازی شبکه",
        "en": "Grid balancing"
  ...
  },
  {
    "productNum": 17,
    "name": {
      "fa": "سیستم ذخیره انرژی صنعتی و تجاری ESS 261kWh (خنک‌کاری مایع)",
      "en": "ESS 261 kWh Liquid Cooling"
    },
    "category": {
      "fa": "ذخیره انرژی صنعتی با خنک‌کاری مایع",
      "en": "Liquid-Cooled Industrial ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "تکنولوژی خنک‌کاری مایع",
        "en": "Liquid cooling technology"
      },
      {
        "fa": "بهره‌گیری از استراتژی‌های سوئیچینگ هوشمند",
        "en": "Intelligent energy switching"
      },
      {
        "fa": "پایداری حرارتی بالا",
        "en": "High thermal stability"
      },
      {
        "fa": "ایمنی در سطح صنعتی",
        "en": "Industrial-grade safety"
      ...
      {
        "fa": "بهینه‌سازی Peak Shaving",
        "en": "Peak shaving optimization"
      },
      {
        "fa": "معماری مستقل AC/DC",
        "en": "Independent AC/DC architecture"
      }
    ],
    "applications": [
      {
        "fa": "پروژه‌های صنعتی در مقیاس بزرگ",
        "en": "Large-scale industrial projects"
      },
      {
        "fa": "سیستم‌های انرژی با بار بالا",
        "en": "High-load energy systems"
      },
      {
        "fa": "ادغام انرژی تجدیدپذیر",
        "en": "Renewable integration"
      },
      {
        "fa": "تأسیسات صنعتی هوشمند",
        "en": "Smart industrial facilities"
      }
    ]
  },
  {
    "productNum": 18,
    "name": {
      "fa": "کابینت فضای باز هیبریدی ذخیره انرژی صنعتی و تجاری با خنک‌کاری هوایی 120kWh",
      "en": "120 kWh Outdoor Hybrid ESS"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی تجاری فضای باز",
      "en": "Outdoor Commercial ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "ساختار مناسب فضای باز",
        "en": "Outdoor-rated structure"
      },
      {
        "fa": "سیستم خنک‌کاری هوایی",
    ...
    "applications": [
      {
        "fa": "سیستم‌های صنعتی فضای باز",
        "en": "Outdoor industrial systems"
      },
      {
        "fa": "پروژه‌های انرژی تجدیدپذیر",
        "en": "Renewable energy projects"
  ...
  },
  {
    "productNum": 19,
    "name": {
      "fa": "کابینت فضای باز هیبریدی ذخیره انرژی صنعتی و تجاری با خنک‌کاری هوایی 261kWh",
      "en": "261 kWh Outdoor Hybrid ESS"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی صنعتی فضای باز",
      "en": "Outdoor Industrial ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "کابینت صنعتی فضای باز",
        "en": "Outdoor industrial cabinet"
      },
      {
        "fa": "ذخیره‌سازی لیتیوم با ظرفیت بالا",
        "en": "High-capacity lithium storage"
      },
      {
        "fa": "مدیریت هوشمند انرژی",
        "en": "Smart energy management"
      ...
      {
        "fa": "کنترل حرارتی هوشمند",
        "en": "Intelligent thermal control"
      },
      {
        "fa": "مقاومت محیطی بالا",
        "en": "High environmental resistance"
      }
    ],
    "applications": [
      {
        "fa": "پروژه‌های انرژی صنعتی",
        "en": "Industrial energy projects"
      },
      {
        "fa": "زیرساخت‌های فضای باز",
        "en": "Outdoor infrastructure"
      },
      {
        "fa": "نیروگاه‌های برق تجدیدپذیر",
        "en": "Renewable power plants"
      },
      {
        "fa": "بهینه‌سازی شبکه",
  ...
  },
  {
    "productNum": 20,
    "name": {
      "fa": "سیستم ذخیره انرژی ESS صنعتی و تجاری کانتینری ۲۰ فوتی",
      "en": "20-Foot Containerized ESS"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی کانتینری",
      "en": "Container Energy Storage System"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "مکانیزم هوشمند طبقه‌بندی و مدیریت خطا",
        "en": "Smart fault classification and management"
      },
      {
        "fa": "سیستم اعلام و اطفاء حریق تمام اتوماتیک",
        "en": "Automatic fire suppression system"
      },
      {
        "fa": "نصب سریع و آسان Plug & Play با کاهش هزینه‌های نصب، بهره‌برداری و نگهداری",
        "en": "Plug & Play installation with reduced cost"
      },
      {
        "fa": "سیستم پیشرفته مدیریت باتری (BMS)",
        "en": "Advanced BMS management"
      },
      {
        "fa": "استاندارد حفاظت IP54",
        "en": "IP54 protection rating"
      }
    ],
    "applications": [
      {
        "fa": "پروژه‌های مقیاس شبکه",
        "en": "Utility-scale projects"
      },
      {
        "fa": "تعادل‌سازی شبکه",
        "en": "Grid balancing"
  ...
  },
  {
    "productNum": 21,
    "name": {
      "fa": "سیستم ذخیره انرژی ESS صنعتی و تجاری کانتینری ۴۰ فوتی",
      "en": "40-Foot Containerized ESS"
    },
    "category": {
      "fa": "سیستم ذخیره انرژی کانتینری در مقیاس بزرگ",
      "en": "Large-Scale Container ESS"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "سیستم کانتینری صنعتی بزرگ",
        "en": "Large industrial container system"
      },
      {
        "fa": "استقرار Plug & Play",
        "en": "Plug-and-play deployment"
      },
      {
        "fa": "مکانیزم هوشمند طبقه‌بندی و مدیریت خطا",
        "en": "Smart fault management"
      },
      {
        "fa": "سیستم اعلام و اطفاء حریق تمام اتوماتیک",
        "en": "Automatic fire suppression"
      },
      {
        "fa": "استاندارد حفاظت IP54",
        "en": "IP54 protection rating"
    ...
    "applications": [
      {
        "fa": "پروژه‌های انرژی در مقیاس شبکه",
        "en": "Utility-scale energy projects"
      },
      {
        "fa": "زیرساخت انرژی تجدیدپذیر",
        "en": "Renewable energy infrastructure"
      },
      {
        "fa": "سیستم‌های پشتیبانی از شبکه",
        "en": "Grid support systems"
      },
      {
        "fa": "استقرارهای صنعتی بزرگ",
        "en": "Large industrial deployments"
      }
    ]
  },
  {
    "productNum": 22,
    "name": {
      "fa": "پلتفرم مدیریت انرژی (EMS)",
      "en": "Energy Management System (EMS)"
    },
    "category": {
      "fa": "پلتفرم انرژی هوشمند",
      "en": "Smart Energy Platform"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "پایش لحظه‌ای وضعیت عملکرد",
        "en": "Real-time status monitoring"
      },
      {
        "fa": "مانیتورینگ و کنترل از راه دور",
        "en": "Remote monitoring and control"
      },
      {
        "fa": "تنظیم حالت‌های عملکرد سیستم",
        "en": "System operation mode configuration"
      },
      {
        "fa": "تنظیم زمان‌بندی ساعات اوج و کم‌باری مصرف",
        "en": "Peak and off-peak scheduling"
      },
      {
        "fa": "اتصال ابری و یکپارچگی IoT",
        "en": "Cloud connectivity and IoT integration"
      },
      {
        "fa": "مدیریت از طریق اپلیکیشن موبایل",
      ...
      {
        "fa": "سیستم هشدار و پیش‌آگاهی مؤثر جهت شناسایی به‌موقع خطاها",
        "en": "Effective warning and pre-notification system"
      }
    ],
    "applications": [
      {
      ...
      {
        "fa": "سیستم‌های انرژی تجاری",
        "en": "Commercial energy systems"
      },
      {
        "fa": "مدیریت انرژی صنعتی",
  ...
  },
  {
    "productNum": 23,
    "name": {
      "fa": "اینورتر هیبریدی میکروگرید",
      "en": "Hybrid Microgrid Inverter"
    },
    "category": {
      "fa": "اینورتر هیبریدی صنعتی",
      "en": "Industrial Hybrid Inverter"
    },
    "description": {
    ...
    "features": [
      {
        "fa": "اینورتر گرید-فرمینگ",
        "en": "Grid-forming inverter"
      },
      {
        "fa": "ظرفیت اضافه بار تا ۱۵۰٪",
        "en": "Up to 150% overload capacity"
      },
      {
        "fa": "قابلیت سوئیچینگ بدون وقفه",
        "en": "Seamless switching capability"
      },
      {
        "fa": "پشتیبانی از حالت هیبریدی با ژنراتور دیزلی",
        "en": "Diesel generator hybrid support"
      },
      {
        "fa": "فناوری کنترل اتصال مستقل شبکه سه فاز",
        "en": "Three-phase independent grid control"
      },
      {
        "fa": "سازگاری با انواع باتری‌ها در سیستم‌های میکروگرید",
        "en": "Multi-battery microgrid compatibility"
      },
      {
        "fa": "عملکرد موازی چندین دستگاه",
        "en": "Parallel operation support"
      }
    ],
    "applications": [
      {
        "fa": "میکروگریدهای صنعتی",
        "en": "Industrial microgrids"
      },
      {
        "fa": "سیستم‌های پشتیبان تجاری",
        "en": "Commercial backup systems"
      ...
      {
        "fa": "ایستگاه‌های شارژ خودروی برقی",
        "en": "EV charging stations"
      },
      {
        "fa": "سیستم‌های خورشیدی + ذخیره‌سازی",
        "en": "Solar + storage systems"
      },
      {
        "fa": "میکروگرید کوچک فتوولتاییک-ذخیره‌سازی-دیزل",
        "en": "PV-Storage-Diesel mini microgrid"
      }
    ]
  }
] as ProductTranslation[];

export function getProductTranslation(productNum: number): ProductTranslation | null {
  return PRODUCT_TRANSLATIONS.find((p) => p.productNum === productNum) ?? null;
}
